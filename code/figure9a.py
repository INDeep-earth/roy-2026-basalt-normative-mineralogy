"""
Figure 9a plotting script for Roy et al. (2026)

Purpose
-------
Plots MAGEMin model output from Figure 9a on the unfolded basalt tetrahedron.
...
- The colour scale is fixed to 1.80–2.20 kbar to match the intended figure style.
"""
...
OUTPUT_FILE = OUTPUT_DIR / "figure9a_magemin_projection.pdf"
...
def main() -> None:
    ...
    df = df.dropna(subset=["normative_name"] + numeric_cols)
    ...
    ax.set_title("Figure 9a", fontsize=13)
