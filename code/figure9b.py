"""
Figure 9b plotting script for Roy et al. (2026)

Purpose
-------
Plots MAGEMin model output from Figure 9b on the unfolded basalt tetrahedron.
...
OUTPUT_FILE = OUTPUT_DIR / "figure9b_magemin_projection.pdf"
...
def main() -> None:
    ...
    ax.set_title("Figure 9b", fontsize=13)
