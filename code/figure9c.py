"""
figure9c.py — Roy et al. (2026), Communications Earth & Environment

Plots MAGEMin thermodynamic fractional crystallisation model output (Fig. 9c)
...
OUTPUT_DIR = Path(r"C:\path\to\output\figure9c")
...
def main() -> None:
    ...
    ax.set_title("Figure 9c — MAGEMin model output", fontsize=13)

    out_path = OUTPUT_DIR / "figure9c_magemin_projection.pdf"
    plt.tight_layout()
